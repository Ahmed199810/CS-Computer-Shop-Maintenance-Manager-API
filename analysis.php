<?php
    ...
    $query_outer = "SELECT * FROM outer_fix";
    ...
    $query_out_done = "SELECT * FROM outer_fix WHERE state = 1";
    ...
    $query_out_not_repaired = "SELECT * FROM outer_fix WHERE state = 2";
    ...
    $query_out_wait = "SELECT * FROM outer_fix WHERE state = 0";
    ...
    if($result = mysqli_query($conn, $query_outer)){
        
        $rowcount = mysqli_num_rows($result);
        $analysis["num_outer"] = $rowcount;
        $response["success"] = 1;
    ...
    if($result = mysqli_query($conn, $query_out_done)){
        
        $rowcount = mysqli_num_rows($result);
        $analysis["num_out_done"] = $rowcount;
        $response["success"] = 1;
 ...
 /*--------------------------------------NOT REPAIRED-----------------------------------------*/
    ...
    if($result = mysqli_query($conn, $query_out_not_repaired)){
        
        $rowcount = mysqli_num_rows($result);
        $analysis["num_out_not"] = $rowcount;
        $response["success"] = 1;
 ...
 /*--------------------------------------SUBMITTED-----------------------------------------*/
    ...
    if($result = mysqli_query($conn, $query_out_wait)){
        
        $rowcount = mysqli_num_rows($result);
        $analysis["num_out_wait"] = $rowcount;
        $response["success"] = 1;
