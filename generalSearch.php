<?php
    ...
    $sql = "SELECT * FROM hardware_fix, software_fix, printer_fix, outer_fix WHERE customer_name like " . "'$word' || phone_num like" . "'$word' || phone_num like" . "'$word' || device_name like" . "'$word' ORDER BY id DESC";
    if($table == "outer_fix"){
        $sql = "SELECT * FROM hardware_fix, software_fix, printer_fix, outer_fix WHERE customer_name like " . "'$word' || customer_phone_num like" . "'$word' || phone_num like" . "'$word' || device_name like" . "'$word' ORDER BY id DESC";
    }else{
        $sql = "SELECT * FROM hardware_fix, software_fix, printer_fix, outer_fix WHERE customer_name like " . "'$word' || phone_num like" . "'$word' || phone_num like" . "'$word' || device_name like" . "'$word' ORDER BY id DESC";
    }
