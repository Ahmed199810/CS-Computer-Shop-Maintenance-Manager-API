...
if (isset($_POST['device_num']) 
    ...
    $sql = "INSERT INTO hardware_fix (device_num, customer_name, phone_num, prob, win7, win8, win10, check_all, hardware, software, battery, charger, bag, cd, other, date_time, device_name, state, device_submitter, date_change_dep, device_receiver) " . "VALUES ("
            . "". $device_num .","
            . "'$customer_name',"
            . "'$phone_number',"
            . "'$prob',"
