<?php
    ...
    $sql = "SELECT * FROM " . "". $table ."" . " WHERE customer_name like " . "'$word' || phone_num like" . "'$word' || phone_num like" . "'$word' || device_name like" . "'$word' ORDER BY id DESC";
    if($table == "outer_fix"){
            $sql = "SELECT * FROM " . "". $table ."" . " WHERE customer_name like " . "'$word' || customer_phone_num like" . "'$word' || device_name like" . "'$word' ORDER BY id DESC";
    }else{
            $sql = "SELECT * FROM " . "". $table ."" . " WHERE customer_name like " . "'$word' || phone_num like" . "'$word' || phone_num like" . "'$word' || device_name like" . "'$word' ORDER BY id DESC";
    }
